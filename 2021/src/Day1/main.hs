...
part1 :: [Int] -> IO ()
part1 = printf "There are %d measurements larger than the previous.\n"
      . count GT
...
part2 :: [Int] -> IO ()
part2 = printf "There are %d measurements larger than the previous.\n"
      . count GT
      . (drop 3 >>= zipWith compare)
...
main = do
    ...
    putStr "Part 1: "  >> part1 measurements
    putStr "Part 2: "  >> part2 measurements
