module Day1.SonarSweep (runMain, part1, part2) where
...
part1 :: [Int] -> Int
part1 measurements = count GT $ zipWith compare (tail measurements) measurements
...
part2 :: [Int] -> Int
part2 measurements = count GT $ zipWith compare (drop 3 measurements) measurements
